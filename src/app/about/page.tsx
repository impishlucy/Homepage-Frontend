...
export function UnityIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 263" {...props}>
      <path
        fill="#FFF1F2FF"
        d="m166.872 131.237l45.91-79.275l22.184 79.275l-22.185 79.256zm-22.376 12.874l45.916 79.262l-79.966-20.486l-57.77-58.776zm45.906-105.033l-45.906 79.275h-91.82l57.77-58.78zm65.539 65.18L227.933.06l-104.54 27.925l-15.475 27.207l-31.401-.225L0 131.244l76.517 76.259h.003l31.388-.232l15.497 27.207l104.528 27.92L255.94 158.22l-15.906-26.982z"
      />
    </svg>
  )
}
...
export function MysqlIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 349" {...props}>
      <path
        fill="#00758f"
  ...
  return (
    <div className="flex w-full flex-col items-center space-y-8 text-center">
      <div className="max-w-2xl space-y-4 px-4">
        <h1 className="mb-0 text-4xl font-bold tracking-tight text-foreground md:text-5xl">
          <span className="text-primary">{data?.fullName || "API ERROR"}</span>
        </h1>
        <p className="mb-6 text-chart-1">{data?.pronouns || "meow"}</p>

        {/* Hardcoded left-to-right layout with dots and hover tooltips */}
        <div className="flex flex-row flex-wrap items-center justify-center gap-3">
          <div className="group relative">
            <CSharpIcon className="h-8 w-8" />
          </div>

          <span className="-my-1 text-xl text-secondary select-none">•</span>
        ...
        <p className="text-lg leading-relaxed text-foreground">
          <span
            dangerouslySetInnerHTML={{
              __html: data?.bio ?? "API could not be reached.",
            }}
          />
        </p>
                ...
                <div key={index} className="relative">
                  <div className="flex flex-col content-center justify-center gap-2 text-center">
                    ...
                    <p className="text-normal text-base font-medium">
                      ...
                      {exp.jobLocation && (
                        <span className="text-normal text-base font-medium">
                          {" • "} {exp.jobLocation}
                        </span>
                      )}
                    </p>
                  ...
                  {index !== (data.jobExperiences?.length || 0) - 1 && (
