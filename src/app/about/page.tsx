  ...
  return (
    <div className="flex flex-col items-center text-center space-y-8 w-full">
      <div className="space-y-4 max-w-2xl px-4">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground mb-0">
          <span className="text-primary">{data?.fullName || "API ERROR"}</span>
        </h1>
        <p className="text-chart-1 mb-6">{data?.pronouns || "meow"}</p>
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-3">
          ...
          <span className="text-secondary text-xl select-none -my-1">•</span>
        ...
        <Card className="bg-card/50 mt-6">
          <CardContent className="p-2 bg-transparent">
            <h2 className="text-xl font-semibold mb-2 text-foreground">Work Experience</h2>
