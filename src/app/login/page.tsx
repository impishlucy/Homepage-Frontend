...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] w-full px-4">
      <div className="w-full max-w-md bg-card/50 backdrop-blur border rounded-lg p-8 space-y-6 text-center">
        ...
        {!error && authUrl && (
          <a
            href={authUrl}
            className="flex items-center justify-center gap-2 w-full h-12 text-base font-medium rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
          >
