...
export default function ImprintPage(): JSX.Element {
  ...
  return (
    <div className="flex w-full flex-col items-center space-y-8 py-8 text-left">
      <div className="w-full max-w-2xl space-y-6 px-4">
        ...
        <Card className="bg-card/50">
          <CardContent className="space-y-6 p-6 text-sm leading-relaxed text-foreground">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p>
                  ...
                  (1) TMG. Under § 8 to 10 TMG, however, we are not obligated as
                  a service provider to monitor transmitted or stored
                  third-party information or to investigate circumstances that
                  indicate illegal activity. Obligations to remove or block the
                  use of information under the general laws remain unaffected. A
                  liability in this respect is, however, only possible from the
                  point in time at which a concrete infringement of the law
                  becomes known. If we become aware of any such infringements,
              ...
              <div className="space-y-2">
                ...
                <p>
                  ...
                  of linking. Illegal contents were not recognizable at the time
                  of linking. However, a permanent control of the contents of
                  the linked pages is not reasonable without concrete evidence
                  of a violation of the law. If we become aware of any
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                hoster&apos;s servers. This may include, but is not limited to,
                IP addresses, browser type, device information, and referrer
                URLs.
              </p>
              <p>
                This data is collected automatically by the hoster&apos;s
                infrastructure via standard HTTP traffic to ensure the secure
                and efficient operation of the website. As the website operator,
                I do not manually collect, merge, analyze, or have direct access
                to delete or modify this server-side log data. The processing is
                based on Art. 6 (1) (f) GDPR (legitimate interest in the
                technically error-free provision of the service).
              </p>
            </section>
          </CardContent>
        </Card>
